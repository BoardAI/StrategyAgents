...
class RolePlaying:
    ...
    def __init__(
        ...
        strategy_prompt_template = "Strategy Sourcing Inc. is a sourcing strategy development company powered by multiple intelligent agents, such as chief executive officer, chief procurement officer, and several specialized experts, with a multi-agent organizational structure and the mission of \"helping companies develop resilient procurement and sourcing strategies\"."
